    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <table class="table table-striped">
                ...
                <tr v-else v-for="item in homework" :key="item.id">
                    <th scope="row">{{ item.id }}</th>
                    <td>{{ item.name }}</td>
                    <td class="text-center">{{ item.description }}</td>
                    <td class="text-center">{{ item.user.lastname + ' ' + item.user.name }}</td>
                    <td class="text-right">
                        <a :href="'homework/' + item.id" class="btn btn-primary btn-sm">
