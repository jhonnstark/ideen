<template>
    <div class="container">
        <div class="row justify-content-center" v-if="type === 'admin'">
            <div class="col">
            ...
            <table class="table">
                ...
                <tr v-else v-for="item in items" :key="item.id">
                    ...
                    <td class="text-right">
                        ...
                        <button @click="paid(item.id)" type="button" class="btn btn-ideen" v-else-if="type === 'admin'">
                            <svg
                        ...
                        <button @click="erase(item.id)" type="button" class="btn btn-danger" v-if="item.paid_at === null && type === 'admin'">
...
export default {
    ...
    data: function () {
        return {
            ...
            items: null,
            isGenerating: false,
            baseIRL: this.type === 'admin' ? '/' + this.type + '/' + this.role : '/' + this.role,
        }
    },
    created () {
        this.updateList();
