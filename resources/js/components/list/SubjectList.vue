    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                <tr v-if="isLoading">
                    <td v-for="n in 3" class="text-center">
                ...
                <tr v-else v-for="item in items" :key="item.id">
                        ...
                        <td>{{ item.name }}</td>
                        <td class="text-right">
                            <a :href="'/' + type + '/subject/edit/' + item.id" type="submit" class="btn btn-primary">
...
export default {
    ...
    created () {
        axios
            .get('/' + this.type + '/subject/list?program=' + this.program)
        ...
        erase: function (id) {
            this.$swal({
                ...
                preConfirm: () => {
                    ...
                    return axios
                        .delete('/' + this.type + '/subject/delete/' + id)
                        .then(response => {
