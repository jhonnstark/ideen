        ...
        <div class="row justify-content-center">
            ...
            <table class="table table-striped">
                ...
                <tr v-for="item in items" :key="item.id">
                    ...
                    <td class="text-right">
                        <a :href="'activity/' + item.id" class="btn btn-primary btn-sm">
                        ...
                        <button v-if="role ==='course'" v-on:click.once="erase(item.id)" type="button" class="btn btn-danger btn-sm">
...
export default {
    ...
    methods: {
        erase: function (id) {
            axios
                .delete(this.id + '/activity/delete/' + id)
                .then(response => {
