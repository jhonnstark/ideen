        ...
        <div class="row justify-content-center">
            ...
            <table class="table table-striped">
                ...
                <tr v-else v-for="item in items" :key="item.id">
                    ...
                    <td class="text-right">
                        <a v-if="item.active ==='Activo'" :href="'activity/' + item.id" class="btn btn-primary btn-sm">
                        ...
                        <button v-if="role ==='module'" @click="erase(item.id)" type="button" class="btn btn-danger btn-sm">
