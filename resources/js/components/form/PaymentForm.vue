<template>
    ...
    <form
        ...
        <div class="form-group row">
            <label for="name" class="col-md-4 col-form-label text-md-right">Concepto</label>
            ...
            <div class="col-md-6">
                <input
                    ...
                    id="name"
                    type="text" class="form-control" name="description" required autocomplete="name" autofocus>
        ...
        <div class="form-group row">
            <label for="price" class="col-md-4 col-form-label text-md-right">Precio neto</label>
            <div class="col-md-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <div class="input-group mb-3">
                    <input
                        v-model.number.trim="$v.record.discount.$model"
                        :class="{ 'is-invalid': $v.record.discount.$error }"
                        id="discount"
                        type="text" class="form-control" name="discount" required autocomplete="discount-bill">

                    <div class="input-group-append">
                        <label class="input-group-text" for="discount">
                            %
                        </label>
                    </div>
...
import {required, minLength, maxLength, between, decimal, minValue} from 'vuelidate/lib/validators';
