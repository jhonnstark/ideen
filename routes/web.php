...
Route::prefix('/course')
    ...
    ->group(function(){
        ...
        Route::get('/module/activity/{activity}/homework', 'HomeController@createActivity')->name('createActivity');
        Route::post('/module/activity/{activity}/homework', 'HomeController@storeActivity');
